...
const initialState = {
    cards: [{flipped: false,
             ...
             back: {text: "Nothing. It just waved", images: ['https://media.giphy.com/media/3o6ZtnIkZgYN172BVu/giphy.gif']}
            },
            {flipped: false,
             front: {text: "What did the beaver say to the tree?", align: "center"},
             back: {text: "It's been nice gnawing you.", images: ["https://i.ytimg.com/vi/EDHRiicoUz0/maxresdefault.jpg"]}
            },
            {flipped: false,
